...
// addCumLogProbs<<<>>> from the template header cannot resolve against the
// instantiation in beamSearchKernels.cu. Expose a host wrapper that lives in
// the same TU as the kernel definition, and have the template code call that.
template <typename T>
